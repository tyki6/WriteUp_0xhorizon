...
Testons maintenant de récupérer la page html de la page admin en lançant une requête vers la page admin puis envoyer le code source sur notre serveur web.
